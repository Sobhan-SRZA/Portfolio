...
const SeoSection: React.FC = (): ReactElement => {
    return (
        <>
            <Helmet>
                {/* فارسی */}
                <meta name="description" lang="fa" content="سبحان رسول زاده اصل (Mr. Sinre/SRZA) — فول‌استک دولوپر: Node.js، React.js، NestJS، توسعه API، ساخت ربات دیسکورد و تلگرام، طراحی و توسعه وب‌سایت." />
            ...
            <section id="seo" style={{ display: "none", visibility: "hidden" }}>
                {/* فارسی */}
                <div lang="fa">
                    <h1>سبحان رسول زاده اصل | Mr. Sinre | Sobhan-SRZA</h1>
                    <p>
                ...
                {/* English */}
                <div lang="en">
                    <h1>Sobhan Rasoulzadeh Asl | Mr. Sinre | Sobhan-SRZA</h1>
                    <p>

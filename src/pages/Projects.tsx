...
const Projects: React.FC = () => {
  ...
  const techColors: { [key: string]: string } = {
    ...
    "discord.js": "text-black bg-[#5865F2] group-hover:scale-105",
    "telegraf.js": "text-black bg-[#FF6161] group-hover:scale-105",
    telegram: "text-black bg-[#26A5E4] group-hover:scale-105",
    discord: "text-black bg-[#5865F2] group-hover:scale-105",
